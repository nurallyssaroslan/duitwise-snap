...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "DuitWise Snap — Allowance Survival Tracker" },
      { property: "og:description", content: "Know if your money can survive until your next allowance. Quick tap, voice, and receipt expense tracking for students." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "DuitWise Snap — Allowance Survival Tracker" },
      { name: "twitter:description", content: "Know if your money can survive until your next allowance. Quick tap, voice, and receipt expense tracking for students." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d7fa5fa9-f81d-490c-8f06-aeab3a4bade0/id-preview-b5c2ec88--2daebc92-36af-43a4-8589-c25ff5cfac58.lovable.app-1778400674412.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d7fa5fa9-f81d-490c-8f06-aeab3a4bade0/id-preview-b5c2ec88--2daebc92-36af-43a4-8589-c25ff5cfac58.lovable.app-1778400674412.png" },
